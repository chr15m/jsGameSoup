...
[Download jsGameSoup v202](http://jsgamesoup.net/jsGameSoup-v202.zip) - jump down to the quickstart section to dive in.
...
[Zipfile of jsGameSoup v202](http://jsgamesoup.net/jsGameSoup-v202.zip)
